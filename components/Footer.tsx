...
const Footer: React.FC = () => {
  return (
    <footer className="py-24 bg-gradient-to-br from-[#F5F1EA] to-[#F0EDE5] px-8">
      ...
      <div className="max-w-7xl mx-auto mt-24 pt-8 border-t border-[#E8E0D5] flex justify-between items-center text-xs font-normal text-[#8B8B8B]">
