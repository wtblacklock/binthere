        ...
        <div className="relative">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-4">
               <img src="https://images.unsplash.com/photo-1518133910546-b6c2fb7d79e3?q=80&w=400" className="rounded-xl w-full h-[320px] object-cover border-4 border-[#1A432D]" alt="Growth" />
               <div className="h-32 bg-[#28A745] rounded-xl flex items-center justify-center text-5xl font-black">+</div>
            </div>
            <div className="space-y-4 pt-12">
               <div className="h-24 bg-white/5 rounded-xl border border-white/10"></div>
               <img src="https://images.unsplash.com/photo-1502086223501-7ea2443f8462?q=80&w=400" className="rounded-xl w-full h-[320px] object-cover border-4 border-[#1A432D]" alt="Peace" />
            </div>
          </div>
        </div>
      </div>
