    ...
    <section className="pt-40 pb-24 md:pt-56 md:pb-32 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div className="max-w-xl">
          <div className="inline-block px-3 py-1 bg-[#D4E7D0] text-[#11311F] text-xs font-bold uppercase tracking-widest rounded-sm mb-6">
          ...
          <p className="text-xl md:text-2xl text-[#4A5D4E] font-medium leading-tight mb-4">
            A simple way to keep your child’s artwork without keeping the clutter.
          </p>
          <p className="text-[#6B7C6E] font-normal mb-10 text-lg">
            Capture it once, feel good recycling the original.
          </p>
        ...
        <div className="relative">
          ...
          <div className="relative group">
            ...
            <img 
              ...
              alt="Dad holding children's artwork" 
              className="w-full aspect-[4/3] object-cover rounded-xl shadow-2xl border-4 border-white"
            />
            <div className="absolute -bottom-8 -left-8 bg-white p-6 rounded-lg shadow-2xl border border-[#E8EEE9] max-w-[240px] hidden md:block">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-3 h-3 bg-[#28A745] rounded-full"></div>
                <span className="text-[10px] font-bold uppercase tracking-widest text-[#6B7C6E]">Memory Saved</span>
              </div>
